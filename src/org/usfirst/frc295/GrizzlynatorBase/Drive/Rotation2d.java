...
import org.usfirst.frc295.GrizzlynatorBase.DriveAdvanced.Interpolable;
...
public class Rotation2d implements Interpolable<Rotation2d>
{
	...
	/**
	 * creates a rotation object using the given x and y as coordinates on the
	 * unit circle
	 *
	 * @param x
	 ...
	 * @param normalize
	 *            whether to use normalizing to reset rounding errors
	 */

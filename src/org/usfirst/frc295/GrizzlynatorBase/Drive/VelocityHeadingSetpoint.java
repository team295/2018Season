...
/**
 * VelocityHeadingSetpoints represents a desired set of wheel speeds and heading of the robot.
 * They are used to calculate the robot's path given the set of wheel
 * speed and the polar coordinates. Especially useful if the robot is negotiating 
 * a turn and to forecast the robot's location.
 */

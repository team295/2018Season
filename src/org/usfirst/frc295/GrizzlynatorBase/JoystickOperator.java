...

{
	...
	public static final short OPERATOR_BUTTON_ELEVATOR_BOTTOM_XBOX = 1; //DPAD BOTTOM

	public static final short OPERATOR_BUTTON_ELEVATOR_VAULT_XBOX = 2; //DPAD LEFT

	public static final short OPERATOR_BUTTON_ELEVATOR_SWITCH_XBOX = 3; //DPAD RIGHT

	public static final short OPERATOR_BUTTON_ELEVATOR_SCALE_XBOX = 4; //DPAD TOP
	
	public static final short OPERATOR_BUTTON_ELEVATOR_RISE_XBOX = 5; //RIGHT TRIGGER
	
	public static final short OPERATOR_BUTTON_ELEVATOR_LOWER_XBOX = 6; //LEFT TRIGGER
	
	//Figure out setup for elevator buttons. DPAD for presets and two others for adjustments?

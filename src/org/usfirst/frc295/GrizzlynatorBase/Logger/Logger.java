...
public class Logger
{
	...
	static public void error(String message, Throwable ex)
	{
		if (ERROR)
		{
			writer.log(LEVEL_ERROR, null, message, ex);
		}
	}
	...
	static public void error(String category, String message, Throwable ex)
	{
		if (ERROR)
		{
			writer.log(LEVEL_ERROR, category, message, ex);
		}
	}
	...
	static public void error(String message)
	{
		if (ERROR)
		{
			writer.log(LEVEL_ERROR, null, message, null);
		}
	}
	...
	static public void error(String category, String message)
	{
		if (ERROR)
		{
			writer.log(LEVEL_ERROR, category, message, null);
		}
	}
	...
	static public void warn(String message, Throwable ex)
	{
		if (WARN)
		{
			writer.log(LEVEL_WARN, null, message, ex);
		}
	}
	...
	static public void warn(String category, String message, Throwable ex)
	{
		if (WARN)
		{
			writer.log(LEVEL_WARN, category, message, ex);
		}
	}
	...
	static public void warn(String message)
	{
		if (WARN)
		{
			writer.log(LEVEL_WARN, null, message, null);
		}
	}
	...
	static public void warn(String category, String message)
	{
		if (WARN)
		{
			writer.log(LEVEL_WARN, category, message, null);
		}
	}
	...
	static public void info(String message, Throwable ex)
	{
		if (INFO)
		{
			writer.log(LEVEL_INFO, null, message, ex);
		}
	}
	...
	static public void info(String category, String message, Throwable ex)
	{
		if (INFO)
		{
			writer.log(LEVEL_INFO, category, message, ex);
		}
	}
	...
	static public void info(String message)
	{
		if (INFO)
		{
			writer.log(LEVEL_INFO, null, message, null);
		}
	}
	...
	static public void info(String category, String message)
	{
		if (INFO)
		{
			writer.log(LEVEL_INFO, category, message, null);
		}
	}
	...
	static public void debug(String message, Throwable ex)
	{
		if (DEBUG)
		{
			writer.log(LEVEL_DEBUG, null, message, ex);
		}
	}
	...
	static public void debug(String category, String message, Throwable ex)
	{
		if (DEBUG)
		{
			writer.log(LEVEL_DEBUG, category, message, ex);
		}
	}
	...
	static public void debug(String message)
	{
		if (DEBUG)
		{
			writer.log(LEVEL_DEBUG, null, message, null);
		}
	}
	...
	static public void debug(String category, String message)
	{
		if (DEBUG)
		{
			writer.log(LEVEL_DEBUG, category, message, null);
		}
	}
	...
	static public void trace(String message, Throwable ex)
	{
		if (TRACE)
		{
			writer.log(LEVEL_TRACE, null, message, ex);
		}
	}
	...
	static public void trace(String category, String message, Throwable ex)
	{
		if (TRACE)
		{
			writer.log(LEVEL_TRACE, category, message, ex);
		}
	}
	...
	static public void trace(String message)
	{
		if (TRACE)
		{
			writer.log(LEVEL_TRACE, null, message, null);
		}
	}
	...
	static public void trace(String category, String message)
	{
		if (TRACE)
		{
			writer.log(LEVEL_TRACE, category, message, null);
		}
	}

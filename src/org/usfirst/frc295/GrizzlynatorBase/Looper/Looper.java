...
/**
 * This code runs all of the robot's Loop objects. Loop objects are stored in a
 * List object. They are started when the robot powers up and stopped after the
 * match.
 */
public class Looper
{
	...
	// RUNNABLE THAT RUNS LOOPS when the Notifier triggers every
	// Constants.LOOPER_PERIOD_SEC

 ...
 * Therefore, since the average ambient temperature at the factory 
 * (on the island of Kauai in Hawaii) may be different than in your environment,
 * you can optionally choose to re-calibrate the gyroscope by pressing and holding
 * the "CAL" button for at least 10 seconds. When you release the "CAL" button, 
 ...
 * 
 * NOTE: It is very important to hold navX-MXP still, and parallel to the earth's 
 * surface, during this Initial Gyro Calibration period. You might consider 
 * performing this process before using your robot the first time it is used 
 * within a new environment (e.g., when you arrive at a FTC competition event).
 */

...
/**
 * This flywheel will support Open Loop, Speed Control and Encoder Count  
 * 1) The RPM speed, the setpoint, and the RPM
...
public class SysLift extends SysCANMotor  
{
    ...
    public SysLift()
    {
        ...
        _talonMaster.setPID(
        		RobotMap.FLYWHEEL_SPEED_KP, 
        		RobotMap.FLYWHEEL_SPEED_KI, 
        		RobotMap.FLYWHEEL_SPEED_KD, 
        		RobotMap.FLYWHEEL_SPEED_KF,
        		RobotMap.FLYWHEEL_SPEED_IZONE, 
        		RobotMap.FLYWHEEL_SPEED_RAMP_RATE, 
                0);

        // POSITION CONTROL PROFILE
        _talonMaster.setProfile(1);
        _talonMaster.setPID(
        		RobotMap.FLYWHEEL_POSITION_KP, 
        		RobotMap.FLYWHEEL_POSITION_KI, 
        		RobotMap.FLYWHEEL_POSITION_KD, 
        		RobotMap.FLYWHEEL_POSITION_KF,
        		RobotMap.FLYWHEEL_POSITION_IZONE, 
        		RobotMap.FLYWHEEL_POSITION_RAMP_RATE, 
                1);
    ...
    public void outputToSmartDashboard() 
    {
        ...
        SmartDashboard.putBoolean("flywheel_on_speed_target", isOnTargetSpeed(RobotMap.FLYWHEEL_SPEED_ONTARGET_TOLERANCE));
